...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"MESS_REGION_BLOCK_NAME" => "Тип покупателя",
		"MESS_PAYMENT_BLOCK_NAME" => "Способ оплаты",
		"MESS_DELIVERY_BLOCK_NAME" => "Способ получения заказа",
		"MESS_BUYER_BLOCK_NAME" => "Данные для доставки",
		"MESS_BACK" => "Назад",
		"MESS_FURTHER" => "Далее",
		"MESS_EDIT" => "изменить",
