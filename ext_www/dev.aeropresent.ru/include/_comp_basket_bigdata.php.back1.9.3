...
<?$APPLICATION->IncludeComponent(
	...
	array(
		...
		"SHOW_PRODUCTS_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "42") => "Y",
		"PROPERTY_CODE_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "42") => array(
			0 => "",
			1 => "",
		),
		"CART_PROPERTIES_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "42") => array(
		),
		"ADDITIONAL_PICT_PROP_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "42") => "MORE_PHOTO",
		"LABEL_PROP_".\Bitrix\Main\Config\Option::get("aspro.max", "CATALOG_IBLOCK_ID", "42") => "-",
