		...
		$('form[name="<?=$arResult["arForm"]["VARNAME"]?>"]').validate({
			...
			submitHandler: function( form ){
				if( $('form[name="<?=$arResult["arForm"]["VARNAME"]?>"]').valid() ){
                    ...
                    window.originalSubmit = eventdata.form.submit;
                    eventdata.form.submit = function () {
                        window.originalSubmit.call(eventdata.form);
                        setTimeout(function () {
                            $.ajax('/ajax/success.php').done(function (html) {
                                $('.popup.jqm-init div').html(html);
                            })
