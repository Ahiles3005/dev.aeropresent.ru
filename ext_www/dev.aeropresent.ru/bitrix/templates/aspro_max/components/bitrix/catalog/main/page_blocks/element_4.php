...
<div class="product-view <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?> main_item_wrapper product-view--mix <?=($sViewPictureDetail === 'square_big' ? 'product-view--big-gallery' : '')?>">
