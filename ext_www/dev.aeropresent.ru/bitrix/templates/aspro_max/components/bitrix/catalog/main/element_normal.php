...
<?$bShowCollapsedBlock = \CMax::GetFrontParametrValue('SHOW_COLLAPSED_BLOCK') === 'Y';?>
<?$bShowTableOneColumn = \CMax::GetFrontParametrValue('SHOW_TABLE_CHARACTERISTICS_ONE_COLUMN') === 'Y';?>
<div class="main-catalog-wrapper details js_wrapper_items flexbox<?= $arTheme["SIDE_MENU"]["VALUE"] === 'LEFT' ? ' flexbox--row-reverse' : ' flexbox--row' ; ?> flexbox--justify-space-between flexbox--align-start flexbox--gap flexbox--gap-32 <?=$bShowCollapsedBlock ? ' show-collapsed' : ''?> <?=$bShowTableOneColumn ? ' show-one-column' : ''?>">
