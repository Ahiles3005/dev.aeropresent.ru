...
$bBigGallery = $arParams["PICTURE_RATIO"] === 'square_big';
?>
...
<div class="product-info <?=(!$showCustomOffer ? "noffer" : "");?> bordered rounded3" id="<?=$arItemIDs["strMainID"];?>">
	...
	<?endif;?>
	<?$productRatingHtml = ob_get_clean();?>
	...
	<?endif;?>
	<?$productArticleHtml = ob_get_clean();?>
	...
	<?$productToolbarHtml = ob_get_clean();?>
	...
	<?}?>
	<?$productBrandTopHtml = ob_get_clean();?>

	<?// top block for big gallery?>
	<?if($bBigGallery):?>
		<?ob_start()?>
		...
		<?$productTopBlockHtml = ob_get_clean();?>
	<?endif;?>
	...
	<div class="flexbox flexbox--row two_columns">
		...
		<?\Aspro\Functions\CAsproMax::showMainGallery([
			...
			'NEED_STICKERS' => $bBigGallery ? true : false,
			'ADDITIONAL_CLASS' => 'left_info',
		], $arResult, $arParams);?>
						...
						<div class="char-side char-toggle-visible <?=($isShowProps ? '' : 'hidden')?>">
							<?TSolution\Functions::showBlockHtml([
								...
								'PARAMS' => [
									...
									'VISIBLE_PROP_WITH_OFFER' => ($arParams["VISIBLE_PROP_WITH_OFFER"] !== "Y" && !$bShowMoreLink),
								]
							])?>
				...
				<div class="main_item_wrapper js-offers-calc product-action product-main">
					...
					<?$frame = $this->createFrame()->begin();?>
						<div class="prices_block">
							...
							<?//top block for big gallery?>
							<?if($bBigGallery):?>	
								<?$this->SetViewTarget('PRODUCT_SIDE_INFO', 50);?>
									<?=$productTopBlockHtml;?>
								<?$this->EndViewTarget();?>
							<?endif;?>
